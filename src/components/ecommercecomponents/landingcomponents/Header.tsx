...
export default function Header() {
  ...
  const socials = [
    {
      icon: FaWhatsapp,
      url: "https://wa.me/526634032690",
      color: "text-green-500",
    },
    {
      icon: FaFacebook,
      url: "https://www.facebook.com/people/Valentto-MX/61583725322560/?mibextid=wwXIfr&rdid=RrX9sfhPDsBAVSS4&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1AapeVXTto%2F%3Fmibextid%3DwwXIfr",
      color: "text-blue-600",
    },
    {
      icon: FaInstagram,
      url: "https://www.instagram.com/valenttomx?igsh=bGZ6YTYycXNidzNm&utm_source=qr",
      color: "text-pink-500",
    },
    {
      icon: FaTiktok,
      url: "https://www.tiktok.com/@valenttomx?_r=1&_t=ZS-93XTe6TzOT7",
        ...
        <div className="fixed inset-0 z-[999] md:hidden">
          ...
          <div className="absolute top-0 right-0 w-3/4 max-w-xs h-full bg-background-dark text-white flex flex-col p-6">
            ...
            <button
              ...
              className="flex items-center gap-3 text-lg font-bold uppercase hover:text-primary transition"
            >
