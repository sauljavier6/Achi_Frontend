...
export default function Catalogo() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-[1440px] flex-1 px-6 md:px-10 lg:px-20 py-8">
      ...
      <section className="flex-1 lg:pl-12">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
          ...
          <div className="flex items-center gap-4">
            <button className="flex items-center gap-2 text-sm font-bold border border-gray-200 dark:border-white/10 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors lg:hidden">
          ...
          {data?.data?.map((product: ProductProps) => (
            ...
            >
              <div className="relative aspect-square overflow-hidden rounded-xl bg-gray-100 dark:bg-white/5">
                ...
                <div className="quick-add absolute bottom-4 left-4 right-4 translate-y-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                  <button
                ...
                {product.Description && (
                  <span className="absolute top-4 left-4 rounded-full bg-primary px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-white">
              ...
              <div className="mt-4 flex flex-col gap-1 px-1">
                <h3 className="text-base font-bold text-[#1b0d0f] dark:text-white">
                  {product.Description}
                </h3>
        ...
        <div className="mt-16 flex flex-col items-center gap-6 border-t border-gray-100 dark:border-white/5 pt-10">
          ...
          {showing < total && (
            <button
              ...
              className="rounded-full border-2 border-[#1b0d0f] dark:border-white px-8 py-3 text-sm font-bold uppercase tracking-widest hover:bg-[#1b0d0f] hover:text-white dark:hover:bg-white dark:hover:text-black transition-all"
            >
              Ver Más
            </button>
          )}
